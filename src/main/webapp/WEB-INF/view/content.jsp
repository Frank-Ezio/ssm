...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="styleid" id = "txt_search_roleid">
						<option value="">---请选择---</option>
						<c:forEach items="${roleList }" var="r">
						 	<option value="${r.styleid }">${r.stylename }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
	...
	<div class="modal fade" id="modal_user_c" role="dialog" aria-labelledby="modal_user_c" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_count").click(function(){
	    			...
	    			$('#modal_user_c').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_user_c").show();
	        });
